...
public class CurvedGroundEditor : Editor {
    ...
    public static void drawPointsOnSceneGui(List<CurvedGroundPoint> points)
    {
        ...
        {
            Handles.color = Color.green;
            var fmh_117_74_638597090375209643 = point.transform.rotation; Vector3 newPosition = Handles.FreeMoveHandle(point.position, HandleUtility.GetHandleSize(point.position) * 0.2f, Vector3.zero, Handles.CubeHandleCap);
